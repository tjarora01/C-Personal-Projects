...
node* assign(node* head) {
    ...
    string doIT = "US-0743";
    for (int i = 0; i<30; i++) {
        put->airport[i] = doIT[i];

    }
    put->distance = 10867;
    put->longitude = 8.4375;
    put->latitude = 11.5231;

    cout << put->airport << endl;
    ...
    for (i = head; i->next != nullptr; i = i->next) {
        ...
        for (j = i->next; j != nullptr; j = j->next) {
            ...
            if ((i->distance > j->distance)) {
                ...
                string temp5 = i->elevation_ft;
                i->elevation_ft = j->elevation_ft;
                j->elevation_ft = temp5;

                string temp6 = i->continent;
                i->continent = j->continent;
                j->continent = temp6;

                string temp7 = i->iso_country;
                i->iso_country = j->iso_country;
                j->iso_country = temp7;

                string temp8 = i->iso_region;
                i->iso_country = j->iso_region;
                j->iso_region = temp8;

                string temp9 = i->municipality;
                i->municipality = j->municipality;
                j->municipality = temp9;

                string temp10 = i->gps_code;
                i->gps_code = j->gps_code;
                j->gps_code = temp10;

                string temp11 = i->lata_code;
                i->lata_code = j->lata_code;
                j->lata_code = temp11;

                string temp12 = i->local_code;
                i->local_code = j->local_code;
                j->local_code = temp12;
